 ...
 */
int __stdcall avformat_open_input(AVFormatContext **ps, const char *filename, AVInputFormat *fmt, AVDictionary **options);
 ...
 *       we do not waste time getting stuff the user does not need.
 */
int __stdcall avformat_find_stream_info(AVFormatContext *ic, AVDictionary **options);
 ...
 */
int __stdcall av_find_best_stream(AVFormatContext *ic,
